...
public final class VirtualWorld extends PApplet {
    ...
    */
    ...
    public void mousePressed() {
        ...
        // Trigger volcano eruption at clicked location
        if (!world.isOccupied(pressed) && world.withinBounds(pressed)) {
            Volcano volcano = new Volcano(
                "volcano_" + pressed.x + "_" + pressed.y,
                pressed,
                imageStore.getImageList("volcano"),
                0.2,  // animation period
                1.0   // action period
            );
            world.addEntity(volcano);
            volcano.scheduleActions(scheduler, world, imageStore);
            System.out.println("VOLCANO ERUPTING at " + pressed.x + ", " + pressed.y);
        }
